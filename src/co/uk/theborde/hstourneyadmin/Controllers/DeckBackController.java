    ...
    private Object loadBacks() {
        ...
        try {
            ...
            for (CardBack cardBack : cardBacks) {
                try {
                    ImageView imageView = new ImageView("/Images/DeckBacks/" + cardBack.getName() + ".png");//cardBack.getImage());
                    ...
                    System.out.println("Caused By: " + cardBack.getName());
                    //ex.printStackTrace();
                }
                index++;
            }
